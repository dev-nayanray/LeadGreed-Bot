...
- Для funnel_slug_override: broker_ids = брокер, override_code = название фаннела (текст), countries = список стран (опционально), affiliate_id = ID аффилиата (опционально)
  ...
  Примеры:
  • "Nexus DE funnel Pemex" → {"action": "funnel_slug_override", "broker_ids": ["Nexus"], "override_code": "Pemex", "countries": ["Germany"], "affiliate_id": null}
  • "добавь фаннел Pemex для Nexus DE ES aff 123" → {"action": "funnel_slug_override", "broker_ids": ["Nexus"], "override_code": "Pemex", "countries": ["Germany", "Spain"], "affiliate_id": "123"}
  • "Nexus funnel override Pemex" → {"action": "funnel_slug_override", "broker_ids": ["Nexus"], "override_code": "Pemex", "countries": [], "affiliate_id": null}
